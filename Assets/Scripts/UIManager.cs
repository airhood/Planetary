...
public class UIManager : MonoBehaviour
{
    ...
    void Start()
    {
        achievementDisplayUI.SetActive(false);
    ...
    public IEnumerator DisplayAchievement(Achievement achievement)
    {
        ...
        achievementDisplayUI.SetActive(true);
    ...
    {
        for(int i = 1; 5 * i <= 255; i++)
        {
            achievementDisplayUI.GetComponent<Image>().color = new Color(achievementDisplayUI.GetComponent<Image>().color.r, achievementDisplayUI.GetComponent<Image>().color.g, achievementDisplayUI.GetComponent<Image>().color.b, 1 - (5 * i/255f));
            achievementDisplayUI.transform.GetChild(0).GetComponent<Text>().color = new Color(achievementDisplayUI.transform.GetChild(0).GetComponent<Text>().color.r, achievementDisplayUI.transform.GetChild(0).GetComponent<Text>().color.g, achievementDisplayUI.transform.GetChild(0).GetComponent<Text>().color.b, 1 - (5 * i / 255f));
            achievementDisplayUI.transform.GetChild(1).GetComponent<Text>().color = new Color(achievementDisplayUI.transform.GetChild(1).GetComponent<Text>().color.r, achievementDisplayUI.transform.GetChild(1).GetComponent<Text>().color.g, achievementDisplayUI.transform.GetChild(1).GetComponent<Text>().color.b, 1 - (5 * i / 255f));
